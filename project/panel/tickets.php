...
<body id="body-pd" style="background-color: #212529;">
        ...
        <nav class="nav">
            <div> <a class="nav_logo" href="dashboard.php"> <i class='bx bx-grid-alt nav_logo-icon'></i> <span
                ...
                <div class="nav_list"><a href="clients.php" class="nav_link" id="users"> <i
                            class='bx bx-user nav_icon'></i> <span class="nav_name">Users</span> </a> <a href="tickets.php"
                        class="nav_link active"> <i class='bx bx-message-square-detail nav_icon'></i> <span
                            class="nav_name">Reports</span> </a> <a href="#" class="nav_link"> <i
    ...
    <div class="height-100 bg-dark" id="main-body" style="color: white">
        <?php
            $stmt = $conn->prepare("SELECT id, topic, SUBSTRING_INDEX(description, ' ', 20) AS short_description, created, last_updated FROM `reports` WHERE status = 1 ORDER BY last_updated DESC");
            $stmt->execute();
